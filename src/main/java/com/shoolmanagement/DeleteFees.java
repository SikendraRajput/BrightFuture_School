...
public class DeleteFees extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		PreparedStatement ps=con.prepareStatement("DELETE FROM studentfees1 WHERE rollnumber=?");
		...
		if(x==0) {
			...
			pw.println("<h6 style='    color: white;\r\n"
					+ "    position: absolute;\r\n"
					+ "    top: 455px;\r\n"
					+ "    left: 430px;'>Student Fees_Record has been delete.</h6>");
		}
